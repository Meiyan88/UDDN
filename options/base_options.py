...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='my', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        ...
        parser.add_argument('--epoch', type=str, default='45', help='which epoch to load? set to latest to use latest cached model')
